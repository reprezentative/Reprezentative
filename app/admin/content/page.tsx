            ...
            {activeTab === "hero" && (
              <>
                <div>
                  ...
                  />
                  <MediaPicker onSelect={(url) => applyMedia("hero", url)} />
                </div>
              ...
              <>
                <div>
                  ...
                  <input
                    ...
                    className="h-9 w-full rounded-md border border-neutral-800 bg-black px-3 text-xs text-white outline-none placeholder:text-neutral-600 focus:border-neutral-500"
                  />
                  <MediaPicker onSelect={(url) => applyMedia("hero_2", url)} />
                </div>
                <div>
                  <label className="mb-1 block text-[0.7rem] font-semibold uppercase tracking-[0.16em] text-neutral-400">
                    Heading
              ...
              <>
                <div>
                  ...
                  <input
                    ...
                    className="h-9 w-full rounded-md border border-neutral-800 bg-black px-3 text-xs text-white outline-none placeholder:text-neutral-600 focus:border-neutral-500"
                  />
                  <MediaPicker onSelect={(url) => applyMedia("promo_left", url)} />
                </div>
                <div>
                  <label className="mb-1 block text-[0.7rem] font-semibold uppercase tracking-[0.16em] text-neutral-400">
                    Heading
              ...
              <>
                <div>
                  ...
                  <input
                    ...
                    className="h-9 w-full rounded-md border border-neutral-800 bg-black px-3 text-xs text-white outline-none placeholder:text-neutral-600 focus:border-neutral-500"
                  />
                  <MediaPicker onSelect={(url) => applyMedia("promo_right", url)} />
                </div>
                <div>
                  <label className="mb-1 block text-[0.7rem] font-semibold uppercase tracking-[0.16em] text-neutral-400">
                    Heading
              ...
              <>
                <div>
                  ...
                  <input
                    ...
                    className="h-9 w-full rounded-md border border-neutral-800 bg-black px-3 text-xs text-white outline-none placeholder:text-neutral-600 focus:border-neutral-500"
                  />
                  <MediaPicker onSelect={(url) => applyMedia("featured_split", url)} />
                </div>
                <div>
                  <label className="mb-1 block text-[0.7rem] font-semibold uppercase tracking-[0.16em] text-neutral-400">
                    Heading
              ...
              <>
                <div>
                  ...
                  <input
                    ...
                    className="h-9 w-full rounded-md border border-neutral-800 bg-black px-3 text-xs text-white outline-none placeholder:text-neutral-600 focus:border-neutral-500"
                  />
                  <MediaPicker onSelect={(url) => applyMedia("full_width_banner", url)} />
                </div>
                <div>
                  <label className="mb-1 block text-[0.7rem] font-semibold uppercase tracking-[0.16em] text-neutral-400">
                    Heading
                    ...
                    >
                      ...
                      <div>
                        ...
                        <input
                          ...
                          className="h-9 w-full rounded-md border border-neutral-800 bg-black px-3 text-xs text-white outline-none placeholder:text-neutral-600 focus:border-neutral-500"
                        />
                        <MediaPicker onSelect={(url) => handleColumnChange(i, "imageUrl", url)} label="Upload" />
                      </div>
                      <div className="grid gap-3 md:grid-cols-2">
                        <div>
                          <label className="mb-1 block text-[0.7rem] font-semibold uppercase tracking-[0.16em] text-neutral-400">
